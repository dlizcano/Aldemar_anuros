---
title: "PriorizaciÃ³n con anuros amenazados"
...
raster_data <- list.files("D:/BoxFiles/Box Sync/CodigoR/Toshiba/Aldemar_anuros/data")
# w <- raster("data/Allobates_juanii/Allobates_juanii.tif", crs="+proj=longlat +datum=WGS84 +ellps=WGS84")
w <- raster("D:/BoxFiles/Box Sync/CodigoR/Toshiba/Aldemar_anuros/shp/boundbox1.tif", crs="+proj=longlat +datum=WGS84 +ellps=WGS84") # get the bounding box
...
for (i in 1:length(raster_data)){
  r <- raster(paste("D:/BoxFiles/Box Sync/CodigoR/Toshiba/Aldemar_anuros/data/", raster_data[i], "/", raster_data[i], ".tif", sep = ""), crs=crs.geo)
  rp <- projectRaster(from = r, to = w,
                      filename = file.path ("D:/BoxFiles/Box Sync/CodigoR/Toshiba/Aldemar_anuros/crop/", raster_data[i]),
                      method = "bilinear",
                      format = "raster",
                      overwrite = TRUE)
...
cons_unit<-readOGR("D:/BoxFiles/Box Sync/CodigoR/Toshiba/Aldemar_anuros/shp",
...
cafe<-readOGR("D:/BoxFiles/Box Sync/CodigoR/Toshiba/Aldemar_anuros/shp",
...
papa<-readOGR("D:/BoxFiles/Box Sync/CodigoR/Toshiba/Aldemar_anuros/shp",
...
cacao<-readOGR("D:/BoxFiles/Box Sync/CodigoR/Toshiba/Aldemar_anuros/shp",
...
platano<-readOGR("D:/BoxFiles/Box Sync/CodigoR/Toshiba/Aldemar_anuros/shp",
...
yuca<-readOGR("D:/BoxFiles/Box Sync/CodigoR/Toshiba/Aldemar_anuros/shp",
...
vacas<-readOGR("D:/BoxFiles/Box Sync/CodigoR/Toshiba/Aldemar_anuros/shp",
...
cafe_rast<-rasterize(cafe.geo[,8], w) # 8 es la columna valor
papa_rast<-rasterize(papa.geo[,8], w) # 8 es la columna valor
cacao_rast<-rasterize(cacao.geo[,8], w) # 8 es la columna valor
platano_rast<-rasterize(platano.geo[,8], w) # 8 es la columna valor
yuca_rast<-rasterize(yuca.geo[,8], w) # 8 es la columna valor
vacas_rast<-rasterize(vacas.geo[,8], w) # 8 es la columna valor
...
## Primer escenario
### lets asume first equal cost, no protected areas, no edge effect
### Conservacion de de 75%, 50%, 40%, 30%, 25%, 20%, y mix (CR=75%, EN=50%, VU=25%)
...
targ<-read.csv("D:/BoxFiles/Box Sync/CodigoR/Toshiba/Aldemar_anuros/code/targets_per_sp.csv")
...
targets40<-as.data.frame(targetsmet(result_scn40)) # Make a data frame using targets meet
...
result_scn30<-marxan(cons_unit_scn1, sp_staked, 
                     targets="30%", # level of protection for each sp
                     spf=2, # species penalty factor for species
                     NUMREPS=500L, # controls the number of solutions in our portfolio
                     NCORES=2L, # number of threads for parallel processing
                     BLM=0) # edge effect
...
result_scn20<-marxan(cons_unit_scn1, sp_staked, 
                     targets="20%", # level of protection for each sp
                     spf=2, # species penalty factor for species
                     NUMREPS=500L, # controls the number of solutions in our portfolio
                     NCORES=2L, # number of threads for parallel processing
                     BLM=0) # edge effect
...
result_scn10<-marxan(cons_unit_scn1, sp_staked, 
                     targets="10%", # level of protection for each sp
                     spf=2, # species penalty factor for species
                     NUMREPS=500L, # controls the number of solutions in our portfolio
                     NCORES=2L, # number of threads for parallel processing
                     BLM=0) # edge effect
...
op<-par(mfrow=c(7,1))
  ...
  hist(rowMeans(targetsmet(result_scn30)), freq=TRUE, xlim=c(0.6,1), las=1,
     main='Histogram of representation in portfolio 30',
     ylab='Frequency of solutions',
     xlab='Proportion of frog species adequately represented'
    )
...
Especies que no cumplen con 40%: `r sp_notargete_names40`. 
Especies que no cumplen con 30%: `r sp_notargete_names30`. 


Especies que no cumplen con 25%: `r sp_notargete_names25`.  
Especies que no cumplen con 20%: `r sp_notargete_names20`. 
...
print(paste(sp_notargete_names40, " do not meet 40% target", sep=""))
print(paste(sp_notargete_names30, " do not meet 30% target", sep=""))
print(paste(sp_notargete_names25, " do not meet 25% target", sep=""))
print(paste(sp_notargete_names20, " do not meet 20% target", sep=""))
print(paste(sp_notargete_names10, " do not meet 10% target", sep=""))
...
print(max(results50.repr))
print(max(results40.repr))
print(max(results30.repr))
print(max(results25.repr))
print(max(results20.repr))
print(max(results10.repr))
...
plot(results2_40, 0, basemap="road", grayscale=TRUE, force_reset = FALSE)
plot(results2_30, 0, basemap="road", grayscale=TRUE, force_reset = FALSE)
plot(results2_25, 0, basemap="road", grayscale=TRUE, force_reset = FALSE)
plot(results2_20, 0, basemap="road", grayscale=TRUE, force_reset = FALSE)
plot(results2_10, 0, basemap="road", grayscale=TRUE, force_reset = FALSE)
plot(results2_mix, 0, basemap="road", grayscale=TRUE, force_reset = FALSE)
  ...
  plot(results2_50, colramp='YlGnBu', basemap="road", grayscale=TRUE, force_reset = FALSE)
    plot(results2_40, colramp='YlGnBu', basemap="road", grayscale=TRUE, force_reset = FALSE)
    plot(results2_30, colramp='YlGnBu', basemap="road", grayscale=TRUE, force_reset = FALSE)
  plot(results2_25, colramp='YlGnBu', basemap="road", grayscale=TRUE, force_reset = FALSE)  
    plot(results2_20, colramp='YlGnBu', basemap="road", grayscale=TRUE, force_reset = FALSE)
...
results3_50<-update(results2_50, ~pu(id=pu.ids, 
                                        cost=pu.costs, 
                                        status=PAs))
results3_40<-update(results2_40, ~pu(id=pu.ids, 
                                        cost=pu.costs, 
                                        status=PAs))
results3_30<-update(results2_30, ~pu(id=pu.ids, 
                                        cost=pu.costs, 
                                        status=PAs))
results3_20<-update(results2_20, ~pu(id=pu.ids, 
                                        cost=pu.costs, 
                                        status=PAs))
...
results3_25<-update(results2_25, ~pu(id=pu.ids, 
                                        cost=pu.costs, 
                                        status=PAs))
results3_10<-update(results2_10, ~pu(id=pu.ids, 
                                        cost=pu.costs, 
                                        status=PAs))
...
results40.repr3<-rowMeans(targetsmet(results3_40))
results30.repr3<-rowMeans(targetsmet(results3_30))
results20.repr3<-rowMeans(targetsmet(results3_20))
results25.repr3<-rowMeans(targetsmet(results3_25))
results10.repr3<-rowMeans(targetsmet(results3_10))
...
op3<-par(mfrow=c(8,1))
  ...
  hist(results50.repr3, freq=TRUE, xlim=c(0,1), las=1,
    ...
    hist(results40.repr3, freq=TRUE, xlim=c(0,1), las=1,
       ylab='Frequency of solutions',
       xlab='Proportion of species adequately represented',
       main="Level of representation with 40%"
  )
    
    hist(results30.repr3, freq=TRUE, xlim=c(0,1), las=1,
       ylab='Frequency of solutions',
       xlab='Proportion of species adequately represented',
       main="Level of representation with 30%"
  )  
  ...
  hist(results25.repr3, freq=TRUE, xlim=c(0,1), las=1,
    ...
    hist(results20.repr3, freq=TRUE, xlim=c(0,1), las=1,
       ylab='Frequency of solutions',
       xlab='Proportion of species adequately represented',
       main="Level of representation with 20%"
  )
    
    hist(results10.repr3, freq=TRUE, xlim=c(0,1), las=1,
       ylab='Frequency of solutions',
       xlab='Proportion of species adequately represented',
       main="Level of representation with 10%"
  )  
 ...
 par(op2) 
  ...
  plot(results3_40, 0, basemap="road", grayscale=TRUE, force_reset = FALSE)
  plot(results3_30, 0, basemap="road", grayscale=TRUE, force_reset = FALSE)
  plot(results3_25, 0, basemap="road", grayscale=TRUE, force_reset = FALSE)
  plot(results3_20, 0, basemap="road", grayscale=TRUE, force_reset = FALSE)
  plot(results3_10, 0, basemap="road", grayscale=TRUE, force_reset = FALSE)
  ...
  # plot(results3_50)#, colramp='YlGnBu', basemap="road", grayscale=TRUE, force_reset = FALSE)
   # plot(results3_40)#, colramp='YlGnBu', basemap="road", grayscale=TRUE, force_reset = FALSE)
    # plot(results3_30)#, colramp='YlGnBu', basemap="road", grayscale=TRUE, force_reset = FALSE)
  # plot(results3_25)#, colramp='YlGnBu', basemap="road", grayscale=TRUE, force_reset = FALSE)  
   # plot(results3_20)#, colramp='YlGnBu', basemap="road", grayscale=TRUE, force_reset = FALSE)
   # plot(results3_10)#, colramp='YlGnBu', basemap="road", grayscale=TRUE, force_reset = FALSE)
...
print(paste(sp_notargete_names75, " do not meet 75% target", sep=""))
print(paste(sp_notargete_names50, " do not meet 50% target", sep=""))
print(paste(sp_notargete_names40, " do not meet 50% target", sep=""))
print(paste(sp_notargete_names30, " do not meet 50% target", sep=""))
print(paste(sp_notargete_names25, " do not meet 25% target", sep=""))
print(paste(sp_notargete_names20, " do not meet 50% target", sep=""))
print(paste(sp_notargete_names10, " do not meet 50% target", sep=""))
print(paste(sp_notargete_namesdif, " do not meet mix% target", sep=""))
...
blm.pars=c(0, 0.1, 1, 10,  100, 250, 500, 750, 1000)
...
legend.cols<-c("#77f442", "#a3f441", "#FFFFB2", "#FED976", "#FEB24C", "#FD8D3C", "#F03B20", "#BD0026", "#fc0000")
...
results5<-update(results3_mix, ~opt(BLM=0.1))
